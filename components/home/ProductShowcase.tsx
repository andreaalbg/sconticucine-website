...
const products = [
  {
    ...
    alt: 'Soggiorno Contemporaneo - Design moderno con linee pulite e materiali premium',
  },
  {
    id: 2,
    ...
    alt: 'Soggiorno Minimalista - Eleganza essenziale e funzionalità',
  },
  {
    id: 3,
    title: 'Living Luxury',
    ...
    alt: 'Soggiorno Luxury - Open space di alta gamma con finiture esclusive',
  },
]
  ...
  return (
    <section className="py-20 bg-white">
      <div className="container-custom">
        ...
        >
          <h2 className="section-title text-gray-800">Le Nostre Collezioni</h2>
        </motion.div>
